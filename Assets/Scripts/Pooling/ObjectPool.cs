...
/// <summary>
	...
	{
		private Dictionary<T, ObjectList> _poolsByPrefab = new();
		private Dictionary<T, ObjectList> _poolsByInstance = new();
		...
		public T AcquireInstance(T prefab, Vector3 pos = default, Quaternion rot = default, Transform parent = default)
		{
			...
			else
			{
				...
				newt.transform.SetPositionAndRotation( pos, rot);
			}
